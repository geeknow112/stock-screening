		...
		<div>
			<table class="table table-bordered text-nowrap">
				<thead class="table-light">
					<tr>
						<th scope="col" id="username" class="">タイトル</th>
						<th scope="col" id="username" class="">内容</th>
						<th scope="col" id="username" class="">商品</th>
						<th scope="col" id="username" class="">チャート</th>
						<th scope="col" id="username" class="">状態</th>
						<th scope="col" id="username" class="">日時</th>
						<th scope="col" id="username" class="">投稿者</th>
						<th scope="col" id="username" class="">投稿名</th>
			...
			@if (isset($rows) && count($rows))
				<tbody id="the-list" data-wp-lists="list:user">
					...
					<tr id="user-1">
						<td colspan="1">
							<a href="{{ $list->goods_url }}" target="_blank">{{ $list->post_title }}</a>
						</td>
						<td>{{-- $list->post_content --}}</td>
						<td><img src="{{ $list->goods_image }}" value="" style="width: 100px;"></td>
<!--						<td><img src="https://m.media-amazon.com/images/I/81KtW1r7J6L._AC_SL1500_.jpg" value="" style="width: 100px;"></td>-->
						<td><img src="{{ $list->chart_image }}" value=""></td>
						<td>{{ $list->post_status }}</td>
